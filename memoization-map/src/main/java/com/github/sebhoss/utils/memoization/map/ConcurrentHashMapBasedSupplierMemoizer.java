...
final class ConcurrentHashMapBasedSupplierMemoizer<KEY, VALUE> extends AbstractConcurrentHashMapBasedMemoizer<KEY, VALUE>
    ...
    ConcurrentHashMapBasedSupplierMemoizer(
        ...
        super(requireNonNull(precomputedValues, "Provide an empty map instead of NULL in case you don't have any precomputed values."));
        this.keySupplier = requireNonNull(keySupplier, "Provide a constant key supplier like this '() -> \"myValue\"'.");
        this.supplier = requireNonNull(supplier, "Cannot memoize a NULL supplier - provide an actual supplier to fix this.");
    }
