...
class MemoizeRxUsingCustomKeyFunctionTest extends UsingCustomKeyFunctionTCK {
    ...
    @Override
    protected <KEY> Action action(final Action action, final Supplier<KEY> keySupplier) {
        return MemoizeRx.action(action, keySupplier);
    }

    @Override
    protected <KEY> Cancellable cancellable(final Cancellable cancellable, final Supplier<KEY> keySupplier) {
        return MemoizeRx.cancellable(cancellable, keySupplier);
    }
    ...
    @Override
    protected <TYPE1, TYPE2, TYPE3, KEY, OUTPUT> Function3<TYPE1, TYPE2, TYPE3, OUTPUT> function3(
            final Function3<TYPE1, TYPE2, TYPE3, OUTPUT> function,
            final Function3<TYPE1, TYPE2, TYPE3, KEY> keyFunction) {
        return MemoizeRx.function3(function, keyFunction);
    }

    @Override
    protected <TYPE1, TYPE2, TYPE3, TYPE4, KEY, OUTPUT> Function4<TYPE1, TYPE2, TYPE3, TYPE4, OUTPUT> function4(
            final Function4<TYPE1, TYPE2, TYPE3, TYPE4, OUTPUT> function,
            final Function4<TYPE1, TYPE2, TYPE3, TYPE4, KEY> keyFunction) {
        return MemoizeRx.function4(function, keyFunction);
    }

    @Override
    protected <TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, KEY, OUTPUT> Function5<TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, OUTPUT> function5(
        ...
        return MemoizeRx.function5(function, keyFunction);
    }

    @Override
    protected <TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, TYPE6, KEY, OUTPUT> Function6<TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, TYPE6, OUTPUT> function6(
        ...
        return MemoizeRx.function6(function, keyFunction);
    }

    @Override
    protected <TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, TYPE6, TYPE7, KEY, OUTPUT> Function7<TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, TYPE6, TYPE7, OUTPUT> function7(
        ...
        return MemoizeRx.function7(function, keyFunction);
    }

    @Override
    protected <TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, TYPE6, TYPE7, TYPE8, KEY, OUTPUT> Function8<TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, TYPE6, TYPE7, TYPE8, OUTPUT> function8(
        ...
        return MemoizeRx.function8(function, keyFunction);
    }

    @Override
    protected <TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, TYPE6, TYPE7, TYPE8, TYPE9, KEY, OUTPUT> Function9<TYPE1, TYPE2, TYPE3, TYPE4, TYPE5, TYPE6, TYPE7, TYPE8, TYPE9, OUTPUT> function9(
        ...
        return MemoizeRx.function9(function, keyFunction);
    }
