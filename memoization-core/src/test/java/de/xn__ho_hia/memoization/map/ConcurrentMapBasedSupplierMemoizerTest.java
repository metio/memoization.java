...
/**
 * Unit tests for ConcurrentMapBasedSupplierMemoizer.
 */
@SuppressWarnings({ CompilerWarnings.NLS, CompilerWarnings.STATIC_METHOD })
public class ConcurrentMapBasedSupplierMemoizerTest {
    ...
    public void shouldAcceptPreComputedValuesKeySupplierAndValueSupplier() {
        ...
        // when
        final ConcurrentMapBasedSupplierMemoizer<String, String> memoizer = new ConcurrentMapBasedSupplierMemoizer<>(
