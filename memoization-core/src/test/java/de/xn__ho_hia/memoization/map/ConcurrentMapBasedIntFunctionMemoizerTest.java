...
public class ConcurrentMapBasedIntFunctionMemoizerTest {
    ...
    public void shouldAcceptCacheAndFunction() {
        ...
        // when
        final ConcurrentMapBasedIntFunctionMemoizer<String, String> memoizer = new ConcurrentMapBasedIntFunctionMemoizer<>(
    ...
    public void shouldRequireNonNullFunction() {
        ...
        // when
        thrown.expect(NullPointerException.class);
        thrown.expectMessage("Cannot memoize a NULL IntFunction - provide an actual IntFunction to fix this.");
