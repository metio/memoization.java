...
public class ConcurrentMapBasedLongFunctionMemoizerTest {
    ...
    public void shouldAcceptCacheAndFunction() {
        ...
        // when
        final ConcurrentMapBasedLongFunctionMemoizer<String, String> memoizer = new ConcurrentMapBasedLongFunctionMemoizer<>(
