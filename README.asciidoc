...
Memoize any of the supported types by using the static factory methods supplied by either using `MapMemoization` or `CaffeineMemoization` like this:
...
Function<I, O> memoizedFunction = CaffeineMemoization.memoize(function);
