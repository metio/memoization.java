...
Supplier<INPUT> memoizedSupplier = MapMemoize.supplier(supplier);
----
...
Supplier<INPUT> supplier = ...;
Map<String, INPUT> cache = ...; // e.g. java.util.concurrent.ConcurrentHashMap
Supplier<INPUT> memoizedSupplier = MapMemoize.supplier(supplier, cache);
----
