...
Memoize any of the supported types by using the static factory methods supplied by either using `CaffeineMemoization`, `GuavaMemoization`, `JCacheMemoization` or `MapMemoization` like this:

[source, java]
----
// using default caches
Consumer<T> consumer = ...;
Consumer<T> memoizedConsumer = CaffeineMemoization.memoize(consumer);

Function<I, O> function = ...;
Function<I, O> memoizedFunction = GuavaMemoization.memoize(function);

Predicate<T> predicate = ...;
Predicate<T> memoizedPredicate = JCacheMemoization.memoize(predicate);
...
Consumer<T> consumer = ...;
Cache<T, T> cache = ...;
Consumer<T> memoizedConsumer = CaffeineMemoization.memoize(consumer, cache);

Function<T, U> function = ...;
Cache<T, U> cache = ...;
Function<T, U> memoizedFunction = GuavaMemoization.memoize(function, cache);

Predicate<T> predicate = ...;
Cache<T, Boolean> cache = ...;
Predicate<T> memoizedPredicate = JCacheMemoization.memoize(predicate, cache);

Supplier<T> supplier = ...;
Map<String, T> cache = ...;
Supplier<T> memoizedSupplier = MapMemoization.memoize(supplier, cache);
----
