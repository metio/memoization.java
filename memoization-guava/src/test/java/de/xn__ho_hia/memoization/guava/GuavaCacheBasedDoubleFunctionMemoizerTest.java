...
public class GuavaCacheBasedDoubleFunctionMemoizerTest {
    ...
    */
    ...
    public void shouldAcceptLoadingCache() {
        ...
        // when
        final GuavaCacheBasedDoubleFunctionMemoizer<String, String> memoizer = new GuavaCacheBasedDoubleFunctionMemoizer<>(
