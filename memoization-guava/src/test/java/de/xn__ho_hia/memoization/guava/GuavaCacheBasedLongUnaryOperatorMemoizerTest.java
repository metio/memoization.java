...
public class GuavaCacheBasedLongUnaryOperatorMemoizerTest {
    ...
    */
    ...
    public void shouldAcceptLoadingCache() {
        ...
        // when
        final GuavaCacheBasedLongUnaryOperatorMemoizer<Long> memoizer = new GuavaCacheBasedLongUnaryOperatorMemoizer<>(
    ...
    */
    ...
    public void shouldTransformInput() {
        ...
        // then
        Assert.assertEquals("Memoized value does not match expectation", 123, memoizer.applyAsLong(789));
    }
