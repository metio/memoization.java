...
public class GuavaCacheBasedIntUnaryOperatorMemoizerTest {
    ...
    */
    ...
    public void shouldAcceptLoadingCache() {
        ...
        // when
        final GuavaCacheBasedIntUnaryOperatorMemoizer<Integer> memoizer = new GuavaCacheBasedIntUnaryOperatorMemoizer<>(
