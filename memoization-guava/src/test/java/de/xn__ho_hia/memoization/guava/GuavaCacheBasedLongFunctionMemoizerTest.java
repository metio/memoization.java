...
public class GuavaCacheBasedLongFunctionMemoizerTest {
    ...
    */
    ...
    public void shouldAcceptLoadingCache() {
        ...
        // when
        final GuavaCacheBasedLongFunctionMemoizer<String, String> memoizer = new GuavaCacheBasedLongFunctionMemoizer<>(
