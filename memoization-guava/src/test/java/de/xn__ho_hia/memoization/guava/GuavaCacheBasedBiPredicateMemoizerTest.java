...
public class GuavaCacheBasedBiPredicateMemoizerTest {
    ...
    */
    ...
    public void shouldAcceptCacheAndKeyFunctionAndBiPredicate() {
        ...
        // when
        final GuavaCacheBasedBiPredicateMemoizer<String, String, String> memoizer = new GuavaCacheBasedBiPredicateMemoizer<>(
