...
public class GuavaCacheBasedIntBinaryOperatorMemoizerTest {
    ...
    */
    ...
    public void shouldAcceptLoadingCache() {
        ...
        // when
        final GuavaCacheBasedIntBinaryOperatorMemoizer<String> memoizer = new GuavaCacheBasedIntBinaryOperatorMemoizer<>(
    ...
    */
    ...
    public void shouldTransformInput() {
        ...
        // then
        Assert.assertEquals(123, memoizer.applyAsInt(123, 789));
    }
