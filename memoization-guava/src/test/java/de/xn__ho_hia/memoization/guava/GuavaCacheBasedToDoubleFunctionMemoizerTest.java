...
public class GuavaCacheBasedToDoubleFunctionMemoizerTest {
    ...
    */
    ...
    public void shouldAcceptLoadingCache() {
        ...
        // when
        final GuavaCacheBasedToDoubleFunctionMemoizer<String, String> memoizer = new GuavaCacheBasedToDoubleFunctionMemoizer<>(
    ...
    */
    ...
    public void shouldTransformInput() {
        ...
        // then
        Assert.assertEquals("Memoized value does not match expectation", 123.456D, memoizer.applyAsDouble("test"),
                0.0D);
    }
