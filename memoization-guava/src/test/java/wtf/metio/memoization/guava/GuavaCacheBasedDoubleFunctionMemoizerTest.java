...
class GuavaCacheBasedDoubleFunctionMemoizerTest {
    ...
    void shouldAcceptLoadingCache() {
        ...
        // when
        final var memoizer = new GuavaCacheBasedDoubleFunctionMemoizer<>(cache, keyFunction, function);
    ...
    void shouldWrapExecutionExceptionInMemoizationException() throws ExecutionException {
        ...
        // when
        final var memoizer = new GuavaCacheBasedDoubleFunctionMemoizer<>(cache, keyFunction, null);
