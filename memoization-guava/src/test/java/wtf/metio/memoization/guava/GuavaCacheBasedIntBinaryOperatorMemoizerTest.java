...
class GuavaCacheBasedIntBinaryOperatorMemoizerTest {
    ...
    void shouldAcceptLoadingCache() {
        ...
        // when
        final var memoizer = new GuavaCacheBasedIntBinaryOperatorMemoizer<>(cache, keyFunction, function);
    ...
    void shouldTransformInput() {
        ...
        // then
        Assertions.assertEquals(123, memoizer.applyAsInt(123, 789));
    }
    ...
    void shouldWrapExecutionExceptionInMemoizationException() throws ExecutionException {
        ...
        // when
        final var memoizer = new GuavaCacheBasedIntBinaryOperatorMemoizer<>(cache, keyFunction, null);

        // then
        Assertions.assertThrows(MemoizationException.class, () -> memoizer.applyAsInt(123, 789));
    }
