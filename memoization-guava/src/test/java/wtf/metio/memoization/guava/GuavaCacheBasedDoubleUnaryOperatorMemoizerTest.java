...
class GuavaCacheBasedDoubleUnaryOperatorMemoizerTest {
    ...
    void shouldAcceptLoadingCache() {
        ...
        // when
        final var memoizer = new GuavaCacheBasedDoubleUnaryOperatorMemoizer<>(cache, keyFunction, function);
    ...
    void shouldTransformInput() {
        ...
        // then
        Assertions.assertEquals(123.456D, memoizer.applyAsDouble(789D), 0.0D);
    }
    ...
    void shouldWrapExecutionExceptionInMemoizationException() throws ExecutionException {
        ...
        // when
        final var memoizer = new GuavaCacheBasedDoubleUnaryOperatorMemoizer<>(cache, keyFunction, null);

        // then
        Assertions.assertThrows(MemoizationException.class, () -> memoizer.applyAsDouble(789D));
    }
