...
class GuavaCacheBasedToIntFunctionMemoizerTest {
    ...
    void shouldAcceptLoadingCache() {
        ...
        // when
        final var memoizer = new GuavaCacheBasedToIntFunctionMemoizer<>(cache, keyFunction, function);
    ...
    void shouldTransformInput() {
        ...
        // then
        Assertions.assertEquals(123, memoizer.applyAsInt("test"));
    }
    ...
    void shouldWrapExecutionExceptionInMemoizationException() throws ExecutionException {
        ...
        // when
        final var memoizer = new GuavaCacheBasedToIntFunctionMemoizer<>(cache, keyFunction, null);

        // then
        Assertions.assertThrows(MemoizationException.class, () -> memoizer.applyAsInt("test"));
    }
