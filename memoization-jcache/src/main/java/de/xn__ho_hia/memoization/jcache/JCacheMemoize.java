...
public final class JCacheMemoize {
    ...
    /**
     * <p>
     * Memoizes a {@link IntToDoubleFunction} in a JCache {@link Cache}.
     * </p>
     * <h3>Features</h3>
     * <ul>
     * <li>Default cache</li>
     ...
     */
    public static final IntToDoubleFunction intToDoubleFunction(final IntToDoubleFunction intToDoubleFunction) {
        return intToDoubleFunction(intToDoubleFunction, createCache(IntToDoubleFunction.class));
    }
    ...
    public static final IntToDoubleFunction intToDoubleFunction(
            final IntToDoubleFunction intToLongFunction,
            final Cache<Integer, Double> cache) {
        return intToDoubleFunction(intToLongFunction, Integer::valueOf, cache);
    }
    ...
    public static final <KEY> IntToDoubleFunction intToDoubleFunction(
            ...
            final IntFunction<KEY> keyFunction) {
        return intToDoubleFunction(intToDoubleFunction, keyFunction, createCache(IntToDoubleFunction.class));
    }
    ...
    public static final <KEY> IntToDoubleFunction intToDoubleFunction(
            ...
            final IntFunction<KEY> keyFunction,
            final Cache<KEY, Double> cache) {
        return new JCacheBasedIntToDoubleFunctionMemoizer<>(cache, keyFunction, intToDoubleFunction);
    }

    /**
     * <p>
     * Memoizes a {@link IntToLongFunction} in a JCache {@link Cache}.
     * </p>
     * <h3>Features</h3>
     * <ul>
     * <li>Default cache</li>
     ...
     */
    public static final IntToLongFunction intToLongFunction(final IntToLongFunction intToLongFunction) {
        return intToLongFunction(intToLongFunction, createCache(IntToLongFunction.class));
    }
    ...
    public static final <KEY> IntToLongFunction intToLongFunction(
            final IntToLongFunction intToLongFunction,
            final IntFunction<KEY> keyFunction) {
        return intToLongFunction(intToLongFunction, keyFunction, createCache(IntToLongFunction.class));
    }
    ...
    /**
     * <p>
     * Memoizes a {@link LongToDoubleFunction} in a JCache {@link Cache}.
     * </p>
     * <h3>Features</h3>
     * <ul>
     * <li>Default cache</li>
     ...
     */
    public static final LongToDoubleFunction longToDoubleFunction(final LongToDoubleFunction longToDoubleFunction) {
        return longToDoubleFunction(longToDoubleFunction, createCache(LongToDoubleFunction.class));
    }
    ...
    public static final <KEY> LongToDoubleFunction longToDoubleFunction(
            final LongToDoubleFunction longToDoubleFunction,
            final LongFunction<KEY> keyFunction) {
        return longToDoubleFunction(longToDoubleFunction, keyFunction, createCache(LongToDoubleFunction.class));
    }
