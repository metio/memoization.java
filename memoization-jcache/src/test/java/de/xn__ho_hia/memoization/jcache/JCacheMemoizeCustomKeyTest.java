...
public class JCacheMemoizeCustomKeyTest {
    ...
    */
    ...
    public void shouldMemoizeIntUnaryOperatorWithKeyFunction() {
        ...
        // when
        final IntUnaryOperator memoize = JCacheMemoize.intUnaryOperator(function, keyFunction);
    ...
    */
    ...
    public void shouldMemoizeToDoubleFunctionWithKeyFunction() {
        ...
        // when
        final ToDoubleFunction<String> memoize = JCacheMemoize.toDoubleFunction(function, keyFunction);
    ...
    */
    ...
    public void shouldMemoizeToLongFunctionWithKeyFunction() {
        ...
        // when
        final ToLongFunction<String> memoize = JCacheMemoize.toLongFunction(function, keyFunction);
