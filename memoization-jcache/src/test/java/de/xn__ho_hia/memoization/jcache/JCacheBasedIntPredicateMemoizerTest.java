...
public class JCacheBasedIntPredicateMemoizerTest {
    ...
    */
    ...
    public void shouldMemoizePredicate() {
        ...
        try (final Cache<String, Boolean> cache = JCacheMemoize.createCache(IntPredicate.class)) {
            // when
            final JCacheBasedIntPredicateMemoizer<String> loader = new JCacheBasedIntPredicateMemoizer<>(cache,
