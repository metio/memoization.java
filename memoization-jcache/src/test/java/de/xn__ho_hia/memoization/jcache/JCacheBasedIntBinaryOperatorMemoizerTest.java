...
public class JCacheBasedIntBinaryOperatorMemoizerTest {
    ...
    */
    ...
    public void shouldMemoizeFunction() {
        ...
        try (final Cache<String, Integer> cache = JCacheMemoize.createCache(DoubleFunction.class)) {
            // when
            final JCacheBasedIntBinaryOperatorMemoizer<String> loader = new JCacheBasedIntBinaryOperatorMemoizer<>(
                    cache, keyFunction, function);

            // then
            Assert.assertEquals("Memoized value does not match expectation", 123, loader.applyAsInt(123, 789));
        }
    }
