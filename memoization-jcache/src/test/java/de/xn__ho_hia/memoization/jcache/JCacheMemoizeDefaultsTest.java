...
public class JCacheMemoizeDefaultsTest {
    ...
    */
    ...
    public void shouldMemoizeDoubleUnaryOperator() {
        ...
        // when
        final DoubleUnaryOperator memoize = JCacheMemoize.doubleUnaryOperator(function);
    ...
    */
    ...
    public void shouldMemoizeIntUnaryOperator() {
        ...
        // when
        final IntUnaryOperator memoize = JCacheMemoize.intUnaryOperator(function);
    ...
    */
    ...
    public void shouldMemoizeLongToDoubleFunction() {
        ...
        // when
        final LongToDoubleFunction memoize = JCacheMemoize.longToDoubleFunction(function);
    ...
    */
    ...
    public void shouldMemoizeLongUnaryOperator() {
        ...
        // when
        final LongUnaryOperator memoize = JCacheMemoize.longUnaryOperator(function);
